...
export function ContactSection() {
  ...
  const handleOnSubmit = (e) => {
    e.preventDefault()
    emailjs.sendForm('service_c05uexc', 'template_7uhhdl9', e.target, 'user_nr74qgS0eRMSZcNdHDHZW').then(
      (result) => {
    ...
    <div className={styles.rootCont} id="contact">
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          <a href="mailto:vaibhav.react@gmail.com">
            <AiOutlineMail className={styles.emailicon} />
          </a>
          <a
            href="https://www.linkedin.com/in/vaibhav121/"
            target="_blank"
            rel="noreferrer"
          >
            <AiFillLinkedin className={styles.linkedInIcon} />
          </a>
          <a href="https://github.com/vaibhavjs" rel="noreferrer" target="_blank">
            <AiOutlineGithub className={styles.gitIcon} />
          </a>
        </div>
        <p className={styles.text}>Phone: 8668370577</p>{" "}
        <p className={styles.text}>Email: vaibhav.react@gmail.com</p>
      </Fade>
    </div>
  )
}
